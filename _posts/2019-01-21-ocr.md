...
[论文](ftp://ftp.idsia.ch/pub/juergen/icml2006.pdf)
...
在CRNN里面使用CTC，还是[这篇](https://zhuanlan.zhihu.com/p/43534801)讲的最好

#### 说说我的理解：

**先说个B变换**，就是，一个字符串state5个字符，如果是由一个12长度的序列组成，所有可能的排列组合：
...
![](/images/20190214/1550127860137.png){:class="myimg"}

总会，CTC很晕，我说说的理解，讲人话吧：
