...
[中文论文](https://blog.csdn.net/v1_vivian/article/details/78599229),[英文论文](http://www.cs.berkeley.edu/~rbg/#girshick2014rcnn)
...
[中文论文](https://alvinzhu.xyz/2017/10/10/fast-r-cnn/)，[英文论文](https://arxiv.org/pdf/1504.08083)
...
大神继续折腾。[论文](https://papers.nips.cc/paper/5638-faster-r-cnn-towards-real-time-object-detection-with-region-proposal-networks.pdf)
...
边框回归的目的既是：给定
$P=(P_x, P_y, P_w, P_h)$，这个P是这个窗口对应的 CNN 特征，也就是 R-CNN 中的 Pool5 feature（特征向量），这话不好理解，他可不是你直接从feature map里面就拿出来的数，而是又经过了一个卷积得到的，不理解，看这个：

[引自](https://www.hhyz.me/2018/04/16/2018-04-16-FasterRCNN/)
![](/images/20190219/1550563590900.png){:class="myimg"}

明白了吧，就说，没有啥$P=(P_x, P_y, P_w, P_h)$，只是你想象出来的而已，
